...
namespace EFCore.NamingConventions.Test
{
    public class NameRewritingConventionTest
    {
        ...
        {
            var entityType = BuildEntity("SimpleBlog", _ => {});
        ...
        {
            var entityType = BuildEntity("SimpleBlog", e => e.Property<int>("SimpleBlogId"));
        ...
        {
            var entityType = BuildEntity("SimpleBlog", e =>
            {
        ...
        private IEntityType BuildEntity(string entityTypeName, Action<EntityTypeBuilder> buildAction, CultureInfo cultureInfo = null)
